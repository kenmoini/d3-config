...
class DMZProvisionerController extends Controller
{

    private $disableTaggingImages = true;

    public function index() {
      return view('dmz-provisioner');
    }
    public function gimmieTagUseStatus() {
      return $this->disableTaggingImages;
    }
    public function gimmieInfrastructureImages($version) {
      switch($version) {
        case "3.11":
          return [
    ...
    public function gimmieOptionalImages($version) {
      switch($version) {
        case "3.11":
          return [
    ...
    public function gimmieBuilderImages($version) {
      switch($version) {
        case "3.11":
          return [
    ...
    public function generateScriptForTheWizard($input) {
      ...
      $disableTaggingImages = $this->disableTaggingImages;
      ...
      $registryImagesInfrastructureThreeEleven = $this->gimmieInfrastructureImages($openshiftVersion);
      $registryImagesOptionalThreeEleven = $this->gimmieOptionalImages($openshiftVersion);
      $registryImagesBuilderThreeEleven = $this->gimmieBuilderImages($openshiftVersion);
