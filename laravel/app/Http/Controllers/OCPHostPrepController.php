  ...
  public function generateScriptForTheWizard($runnerType, $input, $target = "all") {
    ...
    switch($runnerType) {
      ...
      case "prepare-ocp-hosts":
        ...
        $streamedData .= '  name: OCP host preperation' . "\n";
        $streamedData .= '  become: yes' . "\n";
        $streamedData .= '' . "\n";
        $streamedData .= '  tasks:' . "\n";
        $streamedData .= '  - name: Custom RPM repo - Copy template OCP repo file...' . "\n";
        $streamedData .= '    delegate_to: nodes' . "\n";
        $streamedData .= '' . "\n";
        $streamedData .= '  - name: Custom RPM repo - Disable yum subscription-manager plugin...' . "\n";
        $streamedData .= '    delegate_to: nodes' . "\n";
        $streamedData .= '' . "\n";
        $streamedData .= '  - name: Enable OCP repos...' . "\n";
        $streamedData .= '    delegate_to: nodes' . "\n";
        $streamedData .= '' . "\n";
        $streamedData .= '  - name: Run yum update...' . "\n";
        $streamedData .= '    delegate_to: nodes' . "\n";
        $streamedData .= '' . "\n";
        $streamedData .= '  - name: Install OCP packages...' . "\n";
        $streamedData .= '    delegate_to: nodes' . "\n";
        $streamedData .= '' . "\n";
      break;
      case "prepare-registry-hosts":
        $streamedData .= '---' . "\n";
        $streamedData .= '- hosts: ' . $target . "\n";
        $streamedData .= '  name: OCP Registry host preperation' . "\n";
        $streamedData .= '  become: yes' . "\n";
        $streamedData .= '' . "\n";
        $streamedData .= '  tasks:' . "\n";
        $streamedData .= '  - name: Custom RPM repo - Copy template OCP Registry repo file...' . "\n";
        $streamedData .= '    delegate_to: nodes' . "\n";
        $streamedData .= '' . "\n";
        $streamedData .= '  - name: Custom RPM repo - Disable yum subscription-manager plugin...' . "\n";
        $streamedData .= '    delegate_to: nodes' . "\n";
        $streamedData .= '' . "\n";
        $streamedData .= '  - name: Enable OCP Registry repos...' . "\n";
        $streamedData .= '    delegate_to: nodes' . "\n";
        $streamedData .= '' . "\n";
        $streamedData .= '  - name: Run yum update...' . "\n";
        $streamedData .= '    delegate_to: nodes' . "\n";
        $streamedData .= '' . "\n";
        $streamedData .= '  - name: Install OCP Registry packages...' . "\n";
        $streamedData .= '    delegate_to: nodes' . "\n";
        $streamedData .= '' . "\n";
      break;
